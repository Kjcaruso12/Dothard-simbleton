...
const newYorkBusinesses = (companyObject) => {
...
const ManufacturingCompany = (companyObject) => {
...
export const manufacturingCompanies = () => {
    const filteredBusinesses = businesses.filter(ManufacturingCompany)
    return filteredBusinesses
}

export const newYorkCompanies = () => {
    const filteredBusinesses = businesses.filter(newYorkBusinesses)
    return filteredBusinesses
}

export const getBusinesses = () => {
    const businessArray = businesses.map(company => ({ ...company }))
